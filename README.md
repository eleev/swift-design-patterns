...
- [**Iterator:**](/Common%20Design%20Patterns/Behavioral/Iterator/Iterator.md) [[code]](/Common%20Design%20Patterns/Behavioral/Iterator/Iterator.playground/Contents.swift) iterators are used to access the elements of an aggregate object sequentially without exposing its underlying representation
